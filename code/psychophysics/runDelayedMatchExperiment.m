...
p.addParameter('modDirections',{'LightFlux','LminusM_wide'},@iscell);
p.addParameter('targetPhotoreceptorContrast',[0.4, 0.09],@isnumeric);
...
p.addParameter('nTrialsPerBlock',3,@isnumeric);
