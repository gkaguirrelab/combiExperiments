...
summaryTable = table([weeklyMigraineSummary(2); ...  % Migraines per week
    baselineWeeklyMigraineSummary(2); ...
    taskWeeklyMigraineSummary(2)], ...
    [migrainePainSummary(2); ...   % Pain
    baselinePainSummary(2); ...
    taskPainSummary(2)], ...
    [percentMigraineMissingSummary(2); ...  % Percent missing
    baselinePercentMissingSummary(2); ...
    taskPercentMissingSummary(2)],'VariableNames', ...
    {'Migraines per week', ...
