...
[weeklyMigraineSummary, migrainePainSummary] = analyzeDiary(participantList, dataDir, subjSummaryDataDir);
...
%% This section makes a control vs migrainers table with more detailed headache diary analysis
...
% Build summary table
headacheCol = [
    weeklyHeadacheSummary(2);
    baselineWeeklyHeadacheSummary(2);
    taskWeeklyHeadacheSummary(2)
];
migraineCol = [
    weeklyMigraineSummary(2);
    baselineWeeklyMigraineSummary(2);
    taskWeeklyMigraineSummary(2)
];
painCol = [
    migrainePainSummary(2);
    baselinePainSummary(2);
    taskPainSummary(2)
];
missingCol = [
    percentMigraineMissingSummary(2);
    baselinePercentMissingSummary(2);
    taskPercentMissingSummary(2)
];
...
summaryTable = table( ...
    ...
    'VariableNames', { ...
        ...
        'Migraine days per week', ...
        'Mean migraine pain (1–10)', ...
        'Percent missing days' ...
    }, ...
    'RowNames', { ...
        'Overall', ...
        'Baseline', ...
...
% UI TABLE 
f = uifigure('Name','Diary Summary','Position',[100 100 700 250]);

uitable(f, ...
    'Data', summaryTable{:,:}, ...
    'RowName', summaryTable.Properties.RowNames, ...
    'ColumnName', summaryTable.Properties.VariableNames, ...
    'Position', [10 10 680 220], ...
    'FontSize', 14);
