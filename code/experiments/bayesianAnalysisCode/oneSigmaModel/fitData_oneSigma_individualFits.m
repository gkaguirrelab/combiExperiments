...
% NOT RELEVANT FOR ONE SIGMA MODEL
nonLinearConstraint = false; 
    ...
    for lightIdx = 1:nLightLevels
        ...
        for refFreqIdx = 1:nFreqs
            ...
            for contrastIdx = 1:nContrasts
                ...
                initialParam = 0.5; % single sigma value
                priorSame = 0.5; 
                ...
                [fit, fbest] = bads(@(p) negLogLikelihood(p, ...
                    ...
                    nTrials, ...
                    priorSame), ...
                    initialParam, lb, ub, lb, ub, [], options);


                % Add the fVal and sigma values to the matrix
                fValMatrix(subjIdx, contrastIdx, lightIdx, refFreqIdx) = fbest;
                sigmaTestMatrix(subjIdx, contrastIdx,lightIdx,refFreqIdx) = fit;
                sigmaRefMatrix(subjIdx, contrastIdx,lightIdx,refFreqIdx) = fit;
...
if saveData && nonLinearConstraint % saving the data after constrained fitting
    ...
    filename = fullfile(saveDir, [num2str(nSubj) groupLabel '_individualSigmaFits_oneSigma.mat']);
