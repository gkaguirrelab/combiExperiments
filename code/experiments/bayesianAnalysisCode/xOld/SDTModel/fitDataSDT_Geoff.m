...
for refFreqIdx = 1:nFreqs
    ...
    nTrialsCell{refFreqIdx} = thisNTrials;
...
for refFreqIdx = 1:nFreqs
    ...
    thisFit = fit([1, 2, crit_baseline_idx, sigma_idx]);
...
function nll = negLogLikelihood(params, uniqueDbValues, probData, nTrialsCell)
    ...
    for refFreqIdx = 1:nFreqs  % Looping through each ref freq
        ...
        k = probData{refFreqIdx} .* nTrialsCell{refFreqIdx}; % count of diff responses
        N = nTrialsCell{refFreqIdx};
