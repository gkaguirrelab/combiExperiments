function physio = createTapasStruct(saveDir,pulsFilePath,infoFilePath,tr,nScans,nSlices)
%  For documentation of the parameters, see also tapas_physio_new (e.g.,
%  via edit tapas_physio_new)
...
physio.save_dir = saveDir;
physio.log_files.vendor = 'Siemens_Tics';
physio.log_files.cardiac = {pulsFilePath};
physio.log_files.respiration = {''};
physio.log_files.scan_timing = {infoFilePath};
