...
stimSeq = [0,0,4,4,3,4,3,1,3,2,2,5,3,3,5,3,5,4,1,0,1,2,2,2,3,4,4,5,5,2,1,5,4,1,3,2,3,1,1,4,2,4,2,3,1,4,1,5,3,4,5,0,4,5,1,3,1,2,1,2,4,3,2,1,1,5,5,1,4,0,5,2,2,1,0,2,0,3,3,2,5,3,5,2,5,5,1,1,1,3,5,5,1,4,1,2,3,3,0,2,4,5,0,1,5,4,4,2,5,4,2,0,3,3,4,4,0,5,2,4,3,0,0];
stimLabelSet = {'0psi','1psi','2psi','5psi','10psi','20psi'};

maskLabelSet = {'brainstem','GM','WM'};
smoothSD = 0.25;
averageVoxels = false;
useTedanaResults = true;
resultLabel = sprintf(['forwardModel_' sesID '_binned_smooth=%2.1f'],smoothSD);
